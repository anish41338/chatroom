...
# Blueprint for User 3
bp = Blueprint('user3', __name__, url_prefix='/user3', template_folder='templates')
...
def register_socketio_handlers(socketio):
    @socketio.on('send_message', namespace='/user3')
