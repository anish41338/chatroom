...
bp = Blueprint('user1', __name__, url_prefix='/user1', template_folder='templates')
...
def register_socketio_handlers(socketio):
    @socketio.on('send_message', namespace='/user1')
